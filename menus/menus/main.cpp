...
void desenhaObjeto(void){                 //função de desenho
    ...
    glPushMatrix();                       //insere a matriz de transformação corrente na pilha
        triangulo();                       //chama a função que desenha um quadrado
...
void escolhaForma (int opcao){                //verifica a opção escolhida
    switch(opcao){
        case 3:                           //caso  o valor de opção for 0 pinta de vermelho
                //atribui valores as variáveis de cor
        break;
        case 4:                           //caso  o valor de opção for 1 pinta de verde
            r = 0;                        //atribui valores as variáveis de cor
            g = 1;                        //atribui valores as variáveis de cor
            b = 0;                        //atribui valores as variáveis de cor
        break;
        case 5:                           //caso  o valor de opção for 2 pinta de azul
            r = 0;                        //atribui valores as variáveis de cor
            g = 0;                        //atribui valores as variáveis de cor
            b = 1;                        //atribui valores as variáveis de cor
        break;
...
void menuForma(){
    submenucor = glutCreateMenu(escolhaForma);               //cria um novo menu pop-up
    glutAddMenuEntry("Triangulo", 3);                       //adiciona uma entrada de menu na parte inferior do menu atual
    glutAddMenuEntry("Quadrado", 4);                          //adiciona uma entrada de menu na parte inferior do menu atual
    glutAddMenuEntry("Losango", 5);                           //adiciona uma entrada de menu na parte inferior do menu atual
}

void criaMenu(){
    menuCor();                                            //Chama a função que cria o submenu cor
    glutCreateMenu(0);
    //cria um novo menu pop-up (no caso, o principal, onde estarão adicionados os outros submenus)
    glutAddSubMenu("Escolha a Cor", submenucor);
          //adiciona um gatilho de submenu à parte inferior do menu atual
    glutAttachMenu(GLUT_LEFT_BUTTON);
    //anexa um botão do mouse para a janela
    
    menuForma();
    glutCreateMenu(menuForma);
    //cria um novo menu pop-up (no caso, o principal, onde estarão adicionados os outros submenus)
    glutAddSubMenu("Escolha a Forma", submenucor);
          //adiciona um gatilho de submenu à parte inferior do menu atual
    glutAttachMenu(GLUT_LEFT_BUTTON);
